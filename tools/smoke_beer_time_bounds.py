...
int main() {
  ...
  check(parse_row("P;65;10;3^0^1200^30^10;0", row) &&
        row.capacity_num == 3 && row.Speed == 0.0f && row.Param == 1200.0f,
        "строка с реле мешалки и шаговым насосом не сохранилась");
  check(parse_row("P;65;10;3^0^0^30^10;0", row) &&
        row.capacity_num == 3 && row.Speed == 0.0f && row.Param == 0.0f,
        "реле 2 мешалки и реле 1 насоса не сохранились вместе");
