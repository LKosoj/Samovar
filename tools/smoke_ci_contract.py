...
class BrowserTestRunnerTests(unittest.TestCase):
    def test_discovers_every_known_browser_test_file(self) -> None:
        ...
        expected = {
            ...
            # 02.09.2026 (задача 9c): 5-я колонка "Т пара" на bk.htm и бейдж/кнопка авто-воды.
            "test_bk_program_ui_browser.py",
            ...
            "test_mode_navigation_browser.py",
            "test_numeric_input_ui_browser.py",
            "test_p03_runtime_pairs_browser.py",
            "test_profile_operation_ui_browser.py",
            "test_process_scheme_visibility_browser.py",
            ...
            "test_task_t07_column_voltage_browser.py",
            "test_t08_alcohol_ui_browser.py",
            "test_t09_ph_calibration_browser.py",
            "test_t11_chart_session_browser.py",
