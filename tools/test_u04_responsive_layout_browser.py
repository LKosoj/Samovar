...
BROWSER_TEST = r'''async page => {
  ...
  const DESKTOP_GEOMETRY_BASELINE = {
    "setup/Main": { form: {x:290,y:25,width:860,height:1389.55}, panel: {x:320,y:165,width:800,height:1165.55}, actions: {x:386,y:1330.55,width:668,height:54}, save: {x:396,y:1340.55,width:200,height:44}, return: {x:620,y:1340.55,width:200,height:44}, edit: {x:844,y:1340.55,width:200,height:44} },
    ...
    "setup/main-longest-mode": { form: {x:290,y:25,width:860,height:1389.55}, panel: {x:320,y:165,width:800,height:1165.55}, actions: {x:386,y:1330.55,width:668,height:54}, save: {x:396,y:1340.55,width:200,height:44}, return: {x:620,y:1340.55,width:200,height:44}, edit: {x:844,y:1340.55,width:200,height:44} },
    ...
    "setup/validation-error": { form: {x:290,y:25,width:860,height:1473.3}, panel: {x:320,y:248.75,width:800,height:1165.55}, actions: {x:386,y:1414.3,width:668,height:54}, save: {x:396,y:1424.3,width:200,height:44}, return: {x:620,y:1424.3,width:200,height:44}, edit: {x:844,y:1424.3,width:200,height:44} },
    "setup/request-error": { form: {x:290,y:25,width:860,height:1473.3}, panel: {x:320,y:248.75,width:800,height:1165.55}, actions: {x:386,y:1414.3,width:668,height:54}, save: {x:396,y:1424.3,width:200,height:44}, return: {x:620,y:1424.3,width:200,height:44}, edit: {x:844,y:1424.3,width:200,height:44} },
    "setup/visible-tooltip": { form: {x:290,y:25,width:860,height:1389.55}, panel: {x:320,y:165,width:800,height:1165.55}, actions: {x:386,y:1330.55,width:668,height:54}, save: {x:396,y:1340.55,width:200,height:44}, return: {x:620,y:1340.55,width:200,height:44}, edit: {x:844,y:1340.55,width:200,height:44} },
