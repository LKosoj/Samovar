...
BROWSER_TEST = r'''async page => {
  ...
  const DESKTOP_GEOMETRY_BASELINE = {
    ...
    "chart/messages-multiline": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:175.48}, messages: {x:208,y:22,width:600,height:175.48} },
    "chart/chart-empty": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:0}, messages: {x:0,y:0,width:0,height:0} },
    "chart/chart-data": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:0}, messages: {x:0,y:0,width:0,height:0} },
    "chart/chart-error": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:0}, messages: {x:0,y:0,width:0,height:0} },
    "chart/legend": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:0}, messages: {x:0,y:0,width:0,height:0} },
    "chart/refresh": { chartdiv: {x:8,y:8,width:1424,height:500}, panel: {x:8,y:8,width:1424,height:568.36}, canvas: {x:17.39,y:17.39,width:1405.22,height:500}, form: {x:290,y:533,width:860,height:695.42}, host: {x:208,y:22,width:600,height:0}, messages: {x:0,y:0,width:0,height:0} },
  };
  const report = {
