...
BROWSER_TEST = r'''async page => {
  ...
  const base = (index, path) => ({
    ...
    i2cStepperVisible:!!index, i2cPumpVisible:!!index, hideProcessScheme:false,
    beerBrewOrder:'allinone', pwmLow:index ? 200 : 100,
    ...
    i2cSteppers:Array(10).fill({}), calibrationRunning:false, processRunning:false, calibrationPump:'local', cheesePhSlope:1, cheesePhOffset:0,
