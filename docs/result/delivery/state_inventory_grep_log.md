...
modes/rect/rect_runtime.h:337: if (SamovarStatusInt == SAMOVAR_STATUS_RECTIFICATION_WARMUP &&
modes/rect/rect_runtime.h:519: if (SamovarStatusInt == SAMOVAR_STATUS_RECTIFICATION_WARMUP &&
modes/rect/rect_runtime.h:531: SamovarStatusInt = SAMOVAR_STATUS_RECTIFICATION_STABILIZING;
modes/rect/rect_runtime.h:547: if (SamovarStatusInt == SAMOVAR_STATUS_RECTIFICATION_STABILIZING && !boil_started) {
modes/rect/rect_runtime.h:555: if (SamovarStatusInt == SAMOVAR_STATUS_RECTIFICATION_STABILIZING &&
modes/rect/rect_runtime.h:563: SamovarStatusInt = SAMOVAR_STATUS_RECTIFICATION_STABILIZED;
state/globals.h:93: extern volatile int16_t SamovarStatusInt;
...
modes/rect/rect_runtime.h:495: sam_command_sync = SAMOVAR_POWER;
state/globals.h:90: extern volatile SamovarCommands sam_command_sync;
...
app/orchestration.h:497: if (mode_is_rect_runtime(Samovar_Mode)) {
app/orchestration.h:512: } else if (mode_is_distillation_runtime(Samovar_Mode)) {
app/orchestration.h:517: } else if (mode_is_bk_runtime(Samovar_Mode)) {
app/orchestration.h:522: } else if (mode_is_nbk_runtime(Samovar_Mode)) {
app/orchestration.h:527: } else if (mode_is_beer_runtime(Samovar_Mode)) {
...
app/runtime_tasks.h:292: if (mode_is_rect_runtime(Samovar_Mode)) {
app/runtime_tasks.h:294: } else if (mode_is_distillation_runtime(Samovar_Mode)) {
app/runtime_tasks.h:296: } else if (mode_is_bk_runtime(Samovar_Mode)) {
app/runtime_tasks.h:298: } else if (mode_is_nbk_runtime(Samovar_Mode)) {
app/runtime_tasks.h:300: } else if (mode_is_beer_runtime(Samovar_Mode)) {
app/runtime_tasks.h:308: if (mode_is_beer_runtime(Samovar_Mode)) {
app/runtime_tasks.h:349: } else if (mode_is_bk_runtime(Samovar_Mode)) {
app/runtime_tasks.h:351: } else if (mode_is_nbk_runtime(Samovar_Mode)) {
app/runtime_tasks.h:355: else if (mode_is_rect_runtime(Samovar_Mode) && (TargetStepps > 0 || program[ProgramNum].WType == "P")) {
...
modes/rect/rect_runtime.h:153: if (Samovar_Mode != SAMOVAR_RECTIFICATION_MODE) return;
state/globals.h:91: extern volatile SAMOVAR_MODE Samovar_Mode;
...
ui/web/page_assets.h:44: const char* activePage = mode_active_page(Samovar_Mode);
ui/web/page_assets.h:45: Samovar_Mode = mode_runtime_owner(Samovar_Mode);
...
state/globals.h:92: extern volatile SAMOVAR_MODE Samovar_CR_Mode;
...
storage/nvs_profiles.h:21: int mode = (int)Samovar_CR_Mode;
storage/nvs_profiles.h:178: Samovar_CR_Mode = (SAMOVAR_MODE)lastMode;
...
modes/rect/rect_runtime.h:120: (startval == SAMOVAR_STARTVAL_RECT_PROGRAM_RUNNING ||
modes/rect/rect_runtime.h:121: startval == SAMOVAR_STARTVAL_RECT_PROGRAM_COMPLETE)) {
modes/rect/rect_runtime.h:534: wetting_autostart = (startval == SAMOVAR_STARTVAL_RECT_IDLE);
modes/rect/rect_runtime.h:569: if (wetting_autostart && startval == SAMOVAR_STARTVAL_RECT_IDLE) {
state/globals.h:95: extern volatile int16_t startval;
...
io/actuators.h:120: if (boil_started || !PowerOn || !valve_status) {
...
modes/rect/rect_runtime.h:339: PowerOn) {
modes/rect/rect_runtime.h:355: if (!SamSetup.UseHLS || !PowerOn) return;
modes/rect/rect_runtime.h:437: } else if (TankSensor.avgTemp >= OPEN_VALVE_TANK_TEMP && PowerOn) {
modes/rect/rect_runtime.h:443: if (!PowerOn && !is_self_test && valve_status && WaterSensor.avgTemp <= SamSetup.SetWaterTemp - DELTA_T_CLOSE_VALVE && ACPSensor.avgTemp <= MAX_ACP_TEMP - 10) {
modes/rect/rect_runtime.h:475: if ((SteamSensor.avgTemp >= MAX_STEAM_TEMP || WaterSensor.avgTemp >= MAX_WATER_TEMP || TankSensor.avgTemp >= SamSetup.DistTemp || ACPSensor.avgTemp >= MAX_ACP_TEMP) && PowerOn) {
modes/rect/rect_runtime.h:493: if (WFAlarmCount > WF_ALARM_COUNT && PowerOn) {
modes/rect/rect_runtime.h:500: if ((WaterSensor.avgTemp >= ALARM_WATER_TEMP - 5) && PowerOn && alarm_t_min == 0) {
state/globals.h:154: extern volatile bool PowerOn;
...
modes/rect/rect_runtime.h:68: if (!PauseOn && !program_Wait) {
modes/rect/rect_runtime.h:154: if (!stepper.getState() && !PauseOn) return;
modes/rect/rect_runtime.h:155: PauseOn = Pause;
modes/rect/rect_runtime.h:220: PauseOn = false;
state/globals.h:237: extern volatile bool PauseOn;
...
modes/rect/rect_runtime.h:68: if (!PauseOn && !program_Wait) {
modes/rect/rect_runtime.h:70: program_Wait = true;
modes/rect/rect_runtime.h:81: } else if (sensor.avgTemp < sensor.BodyTemp + sensor.SetTemp && millis() >= t_min && t_min > 0 && program_Wait) {
modes/rect/rect_runtime.h:85: program_Wait = false;
modes/rect/rect_runtime.h:142: if (program_Wait && program_Wait_Type == "(Детектор)" && t_min > 0 && millis() >= t_min) {
modes/rect/rect_runtime.h:145: program_Wait = false;
modes/rect/rect_runtime.h:219: program_Wait = false;
state/globals.h:239: extern volatile bool program_Wait;
...
app/orchestration.h:502: } else if (startval != SAMOVAR_STARTVAL_RECT_IDLE && !program_Pause && samovar_status_is_rectification(SamovarStatusInt)) {
app/orchestration.h:504: } else if (startval != SAMOVAR_STARTVAL_RECT_IDLE && program_Pause && samovar_status_is_rectification(SamovarStatusInt)) {
modes/rect/rect_runtime.h:108: if (program_Pause) {
modes/rect/rect_runtime.h:218: program_Pause = false;
modes/rect/rect_runtime.h:297: program_Pause = true;
state/globals.h:238: extern volatile bool program_Pause;
...
io/actuators.h:50: if (!stepper.getState()) cp = false;
modes/rect/rect_runtime.h:154: if (!stepper.getState() && !PauseOn) return;
...
modes/rect/rect_runtime.h:534: wetting_autostart = (startval == SAMOVAR_STARTVAL_RECT_IDLE);
modes/rect/rect_runtime.h:569: if (wetting_autostart && startval == SAMOVAR_STARTVAL_RECT_IDLE) {
modes/rect/rect_runtime.h:570: wetting_autostart = false;
state/globals.h:241: extern bool wetting_autostart;
```
...
io/actuators.h:104: if (!boil_started) {
io/actuators.h:105: boil_started = true;
io/actuators.h:120: if (boil_started || !PowerOn || !valve_status) {
io/actuators.h:190: if (boil_started) {
io/actuators.h:199: return boil_started;
...
modes/rect/rect_runtime.h:547: if (SamovarStatusInt == SAMOVAR_STATUS_RECTIFICATION_STABILIZING && !boil_started) {
modes/rect/rect_runtime.h:549: if (boil_started) {
state/globals.h:216: extern bool boil_started;
...
io/sensor_scan.h:110: sam_command_sync = SAMOVAR_NONE;
io/sensor_scan.h:188: sam_command_sync = SAMOVAR_NONE;
src/core/state/status_codes.h:36: SAMOVAR_NONE,
src/core/state/status_codes.h:55: static constexpr SamovarCommands SAMOVAR_COMMAND_NONE = SAMOVAR_NONE;
ui/lua/bindings_variables.h:7: while (sam_command_sync != SAMOVAR_NONE) {
ui/menu/actions.h:280: sam_command_sync = SAMOVAR_NONE;
```
...
modes/nbk/nbk_alarm.h:48: sam_command_sync = SAMOVAR_POWER;
modes/rect/rect_runtime.h:495: sam_command_sync = SAMOVAR_POWER;
src/core/state/status_codes.h:38: SAMOVAR_POWER,
src/core/state/status_codes.h:57: static constexpr SamovarCommands SAMOVAR_COMMAND_POWER = SAMOVAR_POWER;
ui/lua/bindings_process.h:26: sam_command_sync = SAMOVAR_POWER;
ui/lua/bindings_process.h:28: sam_command_sync = SAMOVAR_POWER;
ui/menu/actions.h:178: sam_command_sync = SAMOVAR_POWER;
ui/web/routes_command.h:66: sam_command_sync = SAMOVAR_POWER;
...
app/loop_dispatch.h:98: if (sam_command_sync != SAMOVAR_RESET) {
io/power_control.h:53: sam_command_sync = SAMOVAR_RESET;
src/core/state/status_codes.h:39: SAMOVAR_RESET,
src/core/state/status_codes.h:58: static constexpr SamovarCommands SAMOVAR_COMMAND_RESET = SAMOVAR_RESET;
ui/web/routes_command.h:84: sam_command_sync = SAMOVAR_RESET;
```
...
src/core/state/status_codes.h:40: CALIBRATE_START,
src/core/state/status_codes.h:59: static constexpr SamovarCommands SAMOVAR_COMMAND_CALIBRATE_START = CALIBRATE_START;
ui/web/routes_service.h:20: sam_command_sync = CALIBRATE_START;
```
...
src/core/state/status_codes.h:41: CALIBRATE_STOP,
src/core/state/status_codes.h:60: static constexpr SamovarCommands SAMOVAR_COMMAND_CALIBRATE_STOP = CALIBRATE_STOP;
ui/web/routes_service.h:23: sam_command_sync = CALIBRATE_STOP;
```
...
src/core/state/status_codes.h:42: SAMOVAR_PAUSE,
src/core/state/status_codes.h:61: static constexpr SamovarCommands SAMOVAR_COMMAND_PAUSE = SAMOVAR_PAUSE;
ui/web/routes_command.h:150: sam_command_sync = SAMOVAR_PAUSE;
```
...
src/core/state/status_codes.h:43: SAMOVAR_CONTINUE,
src/core/state/status_codes.h:62: static constexpr SamovarCommands SAMOVAR_COMMAND_CONTINUE = SAMOVAR_CONTINUE;
ui/web/routes_command.h:148: sam_command_sync = SAMOVAR_CONTINUE;
```
...
src/core/state/status_codes.h:44: SAMOVAR_SETBODYTEMP,
src/core/state/status_codes.h:63: static constexpr SamovarCommands SAMOVAR_COMMAND_SETBODYTEMP = SAMOVAR_SETBODYTEMP;
ui/web/routes_command.h:82: sam_command_sync = SAMOVAR_SETBODYTEMP;
```
...
src/core/state/status_codes.h:64: static constexpr SamovarCommands SAMOVAR_COMMAND_DISTILLATION = SAMOVAR_DISTILLATION;
ui/lua/bindings_process.h:24: sam_command_sync = SAMOVAR_DISTILLATION;
ui/menu/actions.h:154: sam_command_sync = SAMOVAR_DISTILLATION;
ui/web/routes_command.h:68: if (!PowerOn) sam_command_sync = SAMOVAR_DISTILLATION;
ui/web/routes_command.h:126: sam_command_sync = SAMOVAR_DISTILLATION;
...
src/core/state/status_codes.h:65: static constexpr SamovarCommands SAMOVAR_COMMAND_BEER = SAMOVAR_BEER;
ui/lua/bindings_process.h:18: sam_command_sync = SAMOVAR_BEER;
ui/menu/actions.h:146: sam_command_sync = SAMOVAR_BEER;
ui/web/routes_command.h:64: if (!PowerOn) sam_command_sync = SAMOVAR_BEER;
```
...
src/core/state/status_codes.h:67: static constexpr SamovarCommands SAMOVAR_COMMAND_BK = SAMOVAR_BK;
ui/lua/bindings_process.h:20: sam_command_sync = SAMOVAR_BK;
ui/menu/actions.h:162: sam_command_sync = SAMOVAR_BK;
ui/web/routes_command.h:72: if (!PowerOn) sam_command_sync = SAMOVAR_BK;
ui/web/routes_command.h:132: sam_command_sync = SAMOVAR_BK;
...
src/core/state/status_codes.h:68: static constexpr SamovarCommands SAMOVAR_COMMAND_NBK = SAMOVAR_NBK;
ui/lua/bindings_process.h:22: sam_command_sync = SAMOVAR_NBK;
ui/menu/actions.h:170: sam_command_sync = SAMOVAR_NBK;
ui/web/routes_command.h:76: if (!PowerOn) sam_command_sync = SAMOVAR_NBK;
ui/web/routes_command.h:138: sam_command_sync = SAMOVAR_NBK;
...
src/core/state/status_codes.h:50: SAMOVAR_SELF_TEST,
src/core/state/status_codes.h:69: static constexpr SamovarCommands SAMOVAR_COMMAND_SELF_TEST = SAMOVAR_SELF_TEST;
ui/web/routes_command.h:90: sam_command_sync = SAMOVAR_SELF_TEST;
```
...
src/core/state/status_codes.h:52: SAMOVAR_NBK_NEXT
src/core/state/status_codes.h:71: static constexpr SamovarCommands SAMOVAR_COMMAND_NBK_NEXT = SAMOVAR_NBK_NEXT;
ui/web/routes_command.h:58: sam_command_sync = SAMOVAR_NBK_NEXT;
```
...
impurity_detector.h:309: if (Samovar_Mode != SAMOVAR_RECTIFICATION_MODE) {
modes/rect/rect_runtime.h:153: if (Samovar_Mode != SAMOVAR_RECTIFICATION_MODE) return;
src/core/state/mode_codes.h:7: SAMOVAR_RECTIFICATION_MODE = 0,
src/core/state/mode_ownership.h:16: case SAMOVAR_RECTIFICATION_MODE:
src/core/state/mode_ownership.h:20: return SAMOVAR_RECTIFICATION_MODE;
src/core/state/mode_ownership.h:33: case SAMOVAR_RECTIFICATION_MODE:
src/core/state/mode_ownership.h:37: return SAMOVAR_RECTIFICATION_MODE;
src/core/state/mode_ownership.h:51: case SAMOVAR_RECTIFICATION_MODE:
src/core/state/mode_ownership.h:55: return SAMOVAR_RECTIFICATION_MODE;
src/core/state/mode_ownership.h:69: case SAMOVAR_RECTIFICATION_MODE:
src/core/state/mode_ownership.h:89: case SAMOVAR_RECTIFICATION_MODE:
src/core/state/mode_ownership.h:96: return mode_runtime_owner(mode) == SAMOVAR_RECTIFICATION_MODE;
storage/nvs_migration.h:44: SamSetup.Mode = SAMOVAR_RECTIFICATION_MODE;
storage/nvs_profiles.h:22: if (mode < SAMOVAR_RECTIFICATION_MODE || mode > SAMOVAR_LUA_MODE) {
storage/nvs_profiles.h:23: mode = SAMOVAR_RECTIFICATION_MODE;
storage/nvs_profiles.h:31: return (uint8_t)SAMOVAR_RECTIFICATION_MODE;
...
src/core/state/mode_ownership.h:11: return SAMOVAR_DISTILLATION_MODE;
src/core/state/mode_ownership.h:29: case SAMOVAR_DISTILLATION_MODE:
src/core/state/mode_ownership.h:30: return SAMOVAR_DISTILLATION_MODE;
src/core/state/mode_ownership.h:45: case SAMOVAR_DISTILLATION_MODE:
src/core/state/mode_ownership.h:46: return SAMOVAR_DISTILLATION_MODE;
...
src/core/state/mode_ownership.h:8: case SAMOVAR_BEER_MODE:
src/core/state/mode_ownership.h:9: return SAMOVAR_BEER_MODE;
src/core/state/mode_ownership.h:26: case SAMOVAR_BEER_MODE:
src/core/state/mode_ownership.h:28: return SAMOVAR_BEER_MODE;
src/core/state/mode_ownership.h:43: case SAMOVAR_BEER_MODE:
src/core/state/mode_ownership.h:44: return SAMOVAR_BEER_MODE;
...
src/core/state/mode_ownership.h:13: return SAMOVAR_BK_MODE;
src/core/state/mode_ownership.h:34: case SAMOVAR_BK_MODE:
src/core/state/mode_ownership.h:47: case SAMOVAR_BK_MODE:
src/core/state/mode_ownership.h:48: return SAMOVAR_BK_MODE;
src/core/state/mode_ownership.h:65: case SAMOVAR_BK_MODE:
src/core/state/mode_ownership.h:81: case SAMOVAR_BK_MODE:
src/core/state/mode_ownership.h:108: return mode_runtime_owner(mode) == SAMOVAR_BK_MODE;
ui/lua/bindings_process.h:19: } else if (Samovar_Mode == SAMOVAR_BK_MODE && !PowerOn) {
ui/lua/runtime.h:339: case SAMOVAR_BK_MODE:
ui/menu/actions.h:159: } else if (Samovar_Mode == SAMOVAR_BK_MODE) {
ui/web/ajax_snapshot.h:223: if (Samovar_Mode == SAMOVAR_DISTILLATION_MODE || Samovar_Mode == SAMOVAR_RECTIFICATION_MODE || Samovar_Mode == SAMOVAR_BK_MODE || Samovar_Mode == SAMOVAR_NBK_MODE) {
ui/web/routes_command.h:71: } else if (Samovar_Mode == SAMOVAR_BK_MODE) {
...
src/core/state/mode_ownership.h:14: case SAMOVAR_NBK_MODE:
src/core/state/mode_ownership.h:15: return SAMOVAR_NBK_MODE;
src/core/state/mode_ownership.h:31: case SAMOVAR_NBK_MODE:
src/core/state/mode_ownership.h:32: return SAMOVAR_NBK_MODE;
src/core/state/mode_ownership.h:49: case SAMOVAR_NBK_MODE:
src/core/state/mode_ownership.h:50: return SAMOVAR_NBK_MODE;
...
src/core/state/mode_ownership.h:53: case SAMOVAR_LUA_MODE:
src/core/state/mode_ownership.h:87: case SAMOVAR_LUA_MODE:
