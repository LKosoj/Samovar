...
| --- | --- | --- |
| `Samovar_CR_Mode` | Lua, loop/orchestration, other, storage/profile, web routes | `Samovar.ino:255`; `state/globals.h:125`; `storage/nvs_migration.h:41,46,51`; `storage/nvs_profiles.h:21,178`; `ui/lua/bindings_variables.h:48,49,111,112`; `ui/lua/runtime.h:332`; `ui/web/page_assets.h:47`; `ui/web/routes_setup.h:83` |
