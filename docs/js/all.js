...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","Что может Самовар","Самостоятельная сборка и настройка Самовара","Расширение возможностей","WEB-интерфейс. Описание и настройка","Режимы работы Самовара","Зачем нужен Самовар","Логи и Графики","Используемые регуляторы напряжения","Использование разгонного ТЭНа","Аварийная кнопка. Дополнительные аварийные датчики","Первичная настройка скетча","Практические советы"," Кратко о скриптовом языке программирования Lua.","Примеры скриптов","ГЛАВНАЯ","ПРОГРАММА ОТБОРА","Предупреждения системы","Режим первичной дистилляции","Режим ректификации","Пиво","Работа в ручном режиме","Отбор голов","Отбор тела","Предзахлеб","Отбор хвостов","Пауза","Ручная установка скорости отбора","Ручная установка напряжения регулятора  "],
    DREX_NODE_LINKS: ["index.htm","chto_mozhet_samovar.htm","samostoyatelnaya_sborka_i_nastrojka_samovara.htm","rasshirenie_vozmozhnostej.htm","web_interfejs__opisanie_i_nastrojka.htm","rezhimy_raboty_samovara.htm","zachem_nuzhen_samovar.htm","logi_i_grafiki.htm","ispolzuemye_regulyatory_napryazheniya.htm","ispolzovanie_razgonnogo_tehna.htm","avarijnaya_knopka__dopolnitelnye_avarijnye_datchiki.htm","pervichnaya_nastrojka_sketcha.htm","prakticheskie_sovety.htm","_kratko_o_skriptovom_yazyke_programmirovaniya_lua_.htm","primery_skriptov.htm","glavnaya.htm","programma_otbora.htm","preduprezhdeniya_sistemy.htm","rezhim_pervichnoj_distillyatsii.htm","rezhim_rektifikatsii.htm","pivo.htm","rabota_v_ruchnom_rezhime.htm","otbor_golov.htm","otbor_tela.htm","predzakhleb.htm","otbor_khvostov.htm","pauza.htm","ruchnaya_ustanovka_skorosti_otbora.htm","ruchnaya_ustanovka_napryazheniya_regulyatora___.htm"],
    DREX_NODE_CHILD_START: [1,6,8,13,15,18,22,22,22,22,22,22,22,22,22,22,22,22,22,22,27,27,29,29,29,29,29,29,29],
    DREX_NODE_CHILD_END: [6,8,13,15,18,22,22,22,22,22,22,22,22,22,22,22,22,22,22,27,27,29,29,29,29,29,29,29,29],
    DREX_MENU_TYPE: 3,
