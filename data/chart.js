(function () {
  ...
  const SERIES = [
    ...
    { key: 'Pipe', label: 'Температура в царге', color: '#337ab7' },
    { key: 'Water', label: 'Температура воды', color: '#5bc0de' },
    { key: 'Tank', label: 'Температура в кубе', color: '#5cb85c' },
    { key: 'Pressure', label: 'Давление', color: '#f0ad4e' },
    { key: 'ProgNum', label: 'Строка программы', color: '#555555' }
  ];
