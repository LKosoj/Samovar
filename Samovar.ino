//TODO
//
//При старте колонны до стабилизации реализовать выход на предзахлеб (если установлен датчик флегмы) для смачивания насадки (lua)
//В процессе дистилляции при достижении температуры в кубе больше 92 градусов открыть клапан воды для укрепления (lua)
//**************************************************************************************************************
