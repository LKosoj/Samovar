...
//Сделать запись текущего состояния в файл в память ESP32, чтобы в таких ситуациях можно было руками установить программу на последнее состояние. Раз в минуту в режиме ректификации будет писать текущую строку, и сколько отобрал по ней.Сделаю запись текущего состояния в файл в память ESP32, чтобы в таких ситуациях можно было руками установить программу на последнее состояние. Раз в минуту в режиме ректификации будет писать текущую строку, и сколько отобрал по ней.
