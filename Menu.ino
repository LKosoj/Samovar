...
const char str_Steam_T[]  = "Steam temp: ";
const char str_Pipe_T[]  = "Pipe temp: ";
const char str_Water_T[]  = "Water temp: ";
const char str_Tank_T[]  = "Tank temp: ";
...
const char str_Program[]  = "Program>";
