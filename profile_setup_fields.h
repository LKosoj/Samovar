...
#define SAMOVAR_PROFILE_FIELDS(X) \
  ...
  X(U8, DistTimeF, 1, candidate.DistTimeF = 16, ALL) \
  ...
  X(FLOAT, NbkIn, 4, candidate.NbkIn = 0, ALL) \
  X(FLOAT, NbkDelta, 4, candidate.NbkDelta = 0, ALL) \
  X(FLOAT, NbkDM, 4, candidate.NbkDM = 0, ALL) \
  X(FLOAT, NbkDP, 4, candidate.NbkDP = 0, ALL) \
  X(FLOAT, NbkSteamT, 4, candidate.NbkSteamT = 0, ALL) \
  X(FLOAT, NbkOwPress, 4, candidate.NbkOwPress = 0, ALL) \
  ...
  X(FLOAT, NbkTn, 4, candidate.NbkTn = 0.0f, ALL) \
