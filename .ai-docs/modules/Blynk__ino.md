...
Очередь SamovarCommandMsg — статическая FreeRTOS-очередь, через которую Blynk передаёт команды основному циклу
...
Возвращает
Ничего не возвращает, ставит команду через `queue_samovar_command()` или сообщает о занятой очереди
Исключения
Нет
