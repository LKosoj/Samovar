...
//Разница между целевой температурой и текущей температурой (для режимов пиво и су-вид), при которой нагрев будет вестись на полную мощность (в режиме разгона). Если установить 100 - нагрев будет идти в рабочем режиме
#define HEAT_DELTA 0.8

//Температура кипения (для режима пиво), до этой температуры + 0.5 будет греться куб при работе программы кипячение
#define BOILING_TEMP 99.8
//**************************************************************************************************************
...
#define HEATPOWER 125                       //напряжение, которое будет выставлено на регуляторе при поддержании температуры (для режимов пиво и су-вид)
