...
#define IGNORE_HEAD_LEVEL_SENSOR_SETTING     //игнорировать галочку настройки использования датчика урвня флегмы - не важно, включена она или нет, датчик флегмы, если выбран USE_HEAD_LEVEL_SENSOR, будет использоваться всегда
