...
//Температура воды, которую будет поддерживать ШИМ-регулятор, а так же при выключении питания если температура воды будет меньше TARGET_WATER_TEMP - 10 отключится подача воды
