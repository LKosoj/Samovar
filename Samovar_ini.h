...
//Определение типа используемого датчика давления. Может быть использован только один тип. Если раскомментировать оба датчика, то использоваться будет только MPX5010D
