...
#define USE_PRESSURE 32                        //использовать датчик давления. Какое использовать значение - смотреть параметр К в таблице: https://github.com/fanfanlatulipe26/XGZP6897D 
