...
unsigned long alarm_c_min;                                      // Время для ожидания возврата к заданному напряжению-1В для режима предзахлеба в секундах с момента старта ESP32
unsigned long alarm_c_low_min;                                  // Время для ожидания возврата к заданному напряжению-1В для режима предзахлеба в секундах с момента старта ESP32
#endif
