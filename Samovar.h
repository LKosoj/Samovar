...
//**************************************************************************************************************
// Настройки предельных значений температур для контроля автоматики
#define MAX_WATER_TEMP 90
#define MAX_STEAM_TEMP 99
#define CHANGE_POWER_MODE_STEAM_TEMP 77
...
int Power;                                                      //мощность, при которой отбирается эта часть погона.
};
