...
//#define STEPPER_STEP_ML 16064 //количество шагов на 1 мл жидкости для драйвера с шагами 1/16
...
//Значение температуры датчика пара, при котором откроется клапан подачи воды
#define OPEN_VALVE_STEAM_TEMP 59.5
//**************************************************************************************************************
