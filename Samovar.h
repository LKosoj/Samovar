...
volatile float pressure_value;                                  // Давление от датчика давления
volatile float old_pressure_value ;                             // старое давление для усреднения //TODO для усреднения давления
