...
enum SamovarCommands {SAMOVAR_NONE, SAMOVAR_START, SAMOVAR_POWER, SAMOVAR_RESET, CALIBRATE_START, CALIBRATE_STOP, SAMOVAR_PAUSE, SAMOVAR_CONTINUE, SAMOVAR_SETBODYTEMP, SAMOVAR_DISTILLATION, SAMOVAR_BEER, SAMOVAR_BEER_NEXT, SAMOVAR_BK, SAMOVAR_SELF_TEST, SAMOVAR_DIST_NEXT};
volatile SamovarCommands sam_command_sync;                    // переменная для передачи команд между процессами

enum SAMOVAR_MODE {SAMOVAR_RECTIFICATION_MODE, SAMOVAR_DISTILLATION_MODE, SAMOVAR_BEER_MODE, SAMOVAR_BK_MODE, SAMOVAR_SUVID_MODE, SAMOVAR_LUA_MODE};
...
struct SetupEEPROM {
  ...
  byte DistTimeF;                                              //Время в минутах для контроля завершения процесса дистилляции
...
struct WProgram {
  ...
  byte TempSensor;                                             //температурный сенсор, используемый в программе Пиво для контроля нагрева
