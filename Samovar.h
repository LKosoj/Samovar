...
//**************************************************************************************************************
// Пины для UART - связь с регулятором напряжения
#define UART_RX 16
#define UART_TX 17
//**************************************************************************************************************
...
//**************************************************************************************************************
// Пины сенсора охлаждения воды - используется для отключения нагрева в случае отсутствия охлаждения
...
volatile unsigned long WFpulseCount = 0;                        // Счетчик для датчика потока
unsigned int WFflowMilliLitres = 0;                             // Переменная для учета расхода воды
unsigned long WFtotalMilliLitres = 0;                           // Переменная для учета расхода воды
