...
static bool decode_setup_payload_v9only_fields(
    ...
    SetupEEPROM& decoded) {
#define SAMOVAR_GET_BOOL(name) reader.get_bool(decoded.name)
#define SAMOVAR_V9ONLY_TERM_ALL(kind, name)
#define SAMOVAR_V9ONLY_TERM_UPTO4(kind, name)
#define SAMOVAR_V9ONLY_TERM_UPTO5(kind, name)
#define SAMOVAR_V9ONLY_TERM_UPTO6(kind, name)
#define SAMOVAR_V9ONLY_TERM_UPTO7(kind, name)
#define SAMOVAR_V9ONLY_TERM_V2ONLY(kind, name)
...
#undef SAMOVAR_V9ONLY_TERM_UPTO7
#undef SAMOVAR_V9ONLY_TERM_UPTO6
#undef SAMOVAR_V9ONLY_TERM_UPTO5
